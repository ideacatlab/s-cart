        ...
        <div class="rd-navbar-main">
          ...
          <div class="rd-navbar-panel">
            ...
            <div class="rd-navbar-brand">
              <!--Brand--><a class="brand" href="{{ sc_route('home') }}"><img class="brand-logo-dark" src="{{ url('/images/logo/logo.svg') }}" alt="" width="105" height="44"/>
                <img class="brand-logo-light" src="{{ url('/images/logo/logo.svg') }}" alt="" width="106" height="44"/></a>
            </div>
          </div>
          <div class="rd-navbar-nav-wrap">
            ...
            <ul class="rd-navbar-nav">
              ...
              <li class="rd-nav-item">
                  <a class="rd-nav-link" href="{{ sc_route('sales') }}">{{ trans('front.reduceri') }}</a>
              </li>
